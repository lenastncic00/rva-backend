...
public class StatusRestController {
	...
	@ApiOperation(value = "Vraca status iz baze podataka ciji je id vrednost prosledjena kao path varijabla")
	public Status getStatus(@PathVariable("id") Integer id) {
		return statusRepository.getOne(id);
	}
	
	@GetMapping("statusNaziv/{naziv}")
	@ApiOperation(value = "Vraca kolekciju svih statusa iz baze podataka koji u nazivu sadrze string prosledjen kao path varijabla")
	public Collection<Status> getArtiklByNaziv(@PathVariable("naziv") String naziv)
	{
	...
	@ApiOperation(value = "Brisanje statusa iz baze podataka cija je id vrednost prosledjena kao path varijabla")
